...
static int[] valoresX = {0, 0, 0, 0, 0, 0, 0, 0, 0};
static int[] valoresO = {0, 0, 0, 0, 0, 0, 0, 0, 0};
static int[] posX = {0, 0};
static int[] posO = {0, 0};
static int rodada = 0;
...
public static void altera() {
	...
	int maior = 0, maiorX = 0, maiorO = 0, num = 0, numX = 0, numO =0;
//	System.out.println("Altera" );
	...
	//		System.out.println("num :" + num );
		...
		if((valoresX[a]>numX) && (valores[a] < 3))
		{
			maiorX = a; 
			numX = valoresX[a];
		//	System.out.println("Maior X:" + maiorX );
		//	System.out.println("Maior valor X :" + valoresX[a] );
		//	System.out.println("numX :" + numX );
			
		}
		
		if((valoresO[a]>numO) && (valores[a] < 3))
		{
			maiorO = a; 
			numO = valoresO[a];
		//	System.out.println("Maior O :" + maiorO );
		//	System.out.println("Maior valor O :" + valoresO[a] );
	...
	if(rodada % 2 == 0)
	{
		...
		//		System.out.println("Maior X\n");
			...
			else if(maiorO == 0 && numO > 1)
			{	
		//		System.out.println("Maior O\n");
				if(listOfLists.get(0).get(0) == 0)
				{
					listOfLists.get(0).set(0,1);	
				}
